...
- Current next direction: do not tune thresholds or add broad tempo aliases for the completed Round4 gate. The next validation step should be a new drum-group coverage gate or user-provided held-out batch, not repeating the same E-GMD repair loop.
